    ...
    return (
        <>
            ...
            <div className="relative w-full min-h-screen">
                {/* Image BG*/}
                <div
                    style={{ backgroundImage: `url('/img/${data.meta.img_couverture}')` }}
                    className="bg-cover bg-center min-h-screen w-full blur-[3px] opacity-90 absolute"
                ></div>
                                ...
                                <div className="flex gap-8 items-center unselectable">
                                    ...
                                    {data.meta.lien ? <button className="group bg-[#4f4f4f] hover:bg-[#313235] py-2 px-6 rounded-md">
                                        <a href={data.meta.lien} target="_blank" className="flex items-center gap-4">
                                            ...
                                            <p>Commencer à {data.category === "Livres" ? "lire" : "visionnez"}</p>
                                        </a>
                                    </button> : null}
