...
export default function UpdateLivreForm({ SMF, tags, entity }) {
    ...
    function submit(e) {
        ...
        put(route, {
            data,
            onError: () => { SMF(3, "Le livre n'a pas été modifié") },
            onSuccess: () => {
                SMF(1, "Le livre à été modifié")
            }
        })
    }
                ...
                <div className="pl-4 w-full flex flex-col gap-2 max-w-[60%]">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="form__group field !w-2/3">
                            ...
                            <label htmlFor="realisateur" className="form__label">Auteur du livre (Ne peut pat être modifié)</label>
                        </div>
