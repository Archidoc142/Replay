...
export default function CarrouselImage({ images, title, image_name = false }) {
    ...
    return (
        <div className="bg-[#5050502d] pt-8 pb-6">
            <div className="center gap-4 mb-4">
                ...
                <h3 className="text-[#ff5e00] text-4xl">{title}</h3>
            </div>
            ...
            <div className="center gap-8">
                ...
                <div className="flex justify-center min-w-[60%] max-w-[60%] relative"> {/* À changer pour le type d'image*/}
                    {
                        images.map((img, i) => (
                            <Image
                                key={img.id}
                                ...
                                className={"rounded-xl max-h-[520px] " + (index !== i ? "hidden" : "")}
                    ...
                    <div className="absolute bottom-2 left-2 bg-[#3838389d] p-2 rounded-lg unselectable">
                        { image_name ? <p>Titre : {images[index].title}</p> : null}
