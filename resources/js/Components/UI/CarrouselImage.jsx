...
export default function CarrouselImage({ images }) {
    ...
    return (
        <div className="bg-[#5050502d] text-[#ff5e00] pt-8 pb-6 relative">
            <div className="center gap-4 mb-4">
                ...
                <h3 className="text-4xl">Wallpaper à l'affiche</h3>
            </div>
            ...
            <div className="center gap-8">
                ...
                <div className="flex min-w-[60%] max-w-[60%]"> {/* À changer pour le type d'image*/}
                    {
                        images.map((img, i) => (
                            <Image
                                key={img.id}
