...
export default function PopUp({ setShow, children, className }) {
    ...
    return (
        <>
            ...
            <div className={"fixed flex flex-col z-40 bg-gray-800 rounded-xl p-4 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 " + className}>
