...
export default function LeftNav({ genres }) {
    ...
    return (
        <div className="fixed h-screen w-72 z-50 bg-[#14151a] overflow-x-hidden">
            ...
            <div className="flex flex-col">
                ...
                {/* Genres*/}
                <div onClick={() => setSecondaryPanel(!secondaryPanel)} className="hover:bg-[#23252b] text-lg px-4 py-[12px] cursor-pointer flex items-center justify-between">
                    <p>Genre</p>
