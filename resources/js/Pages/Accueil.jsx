...
import MainImagesCarrousel from "@/Components/UI/MainImagesCarrousel"
import VideoNamecard from "@/Components/UI/Namecard/VideoNamecard"
import { Head } from "@inertiajs/react"
import { useEffect, useState } from "react"

export default function Accueil({ leftNav, last_items, musics, images_main, images_d, images_f, video }) {
    ...
    const musicOrder = musics.data.sort((a, b) => a.meta.img_couverture.localeCompare(b.meta.img_couverture))
    ...
    return (
        <>
            ...
            <MainImagesCarrousel images={images_main.data} />
            ...
            <div className="my-6">
                <div className="flex justify-center gap-6 mb-6">
                    ...
                    <h3 className="unselectable text-3xl text-[#ff5e00]">Vidéos</h3>
                </div>
